        ...
        <div class="overall-body">
            ...
            <div class="output-panel">
                ...
                <div class="nav-card">
                    ...
                    <a class="each-card btn btn-primary text-start active" href="dashboard_borrow.php">
                        <i class="bi bi-clipboard-check-fill"></i>&emsp;
                        Find Book Issue
                    </a>
                    <a class="each-card btn btn-primary text-start" href="dashboard_student.php">
                            ...
                            <div class="panel-body">
                                <div class="table-responsive">
                                    <table id="book_table" class="table table-hover">
                                        <caption>List of Borrowed Books</caption>
                                        <thead>
                                            <tr>
